...
const typewriterPhrases = ['digital products.', 'interactive experiences.', 'scalable platforms.'];
...
const runTypewriter = () => {
    ...
    heroTypewriter.textContent = currentPhrase.slice(0, typewriterChar);

    if (typewriterChar < currentPhrase.length) {
        typewriterChar += 1;
